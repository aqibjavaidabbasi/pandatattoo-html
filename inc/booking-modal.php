<?php
require_once __DIR__ . '/contentful.php';
require_once __DIR__ . '/sanitize.php';

$booking_modal_args = $booking_modal_args ?? [];
$is_inline = !empty($booking_modal_args['inline']);
$artist_id = wp_sanitize_text_field($booking_modal_args['artist_id'] ?? '');
$artist_name = (string) ($booking_modal_args['artist_name'] ?? '');
$artist_slug_for_js = '';
if (!empty($booking_modal_args['artist_slug'])) {
    $artist_slug_for_js = wp_sanitize_key($booking_modal_args['artist_slug']);
} elseif (!empty($_GET['artist'])) {
    $artist_slug_for_js = wp_sanitize_key($_GET['artist']);
} elseif ($artist_name !== '') {
    $artist_slug_for_js = cf_sanitize_title($artist_name);
}

$modal_artists = [];
foreach (cf_artists(['limit' => 50, 'order' => 'fields.artistName']) as $artist) {
    $slug = wp_sanitize_key($artist['slug'] ?? $artist['name'] ?? '');
    $name = trim((string) ($artist['name'] ?? ''));
    if ($slug !== '' && $name !== '') $modal_artists[] = ['slug' => $slug, 'name' => $name];
}
...
?>
<script>
    function bookingForm(isInlineMode = <?= $is_inline ? 'true' : 'false' ?>) {
        return {
            open: isInlineMode,
            step: 1,
            isLoading: false,
            ...
            isImageView: false,
            selectedPositions: [],
			artistSlug: <?= json_encode($artist_slug_for_js, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>,
            artistLocked: <?= $artist_id !== '' ? 'true' : 'false' ?>,
            artists: <?= json_encode($modal_artists, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>,
            ...
            async submitForm() {
                ...
                try {
                    // The real file, not the /wp-json/ alias — that alias only exists if the
                    // host honours our .htaccess, and booking must not depend on that.
                    let res = await fetch('<?= url('/api/booking-submit.php') ?>', {
                        method: 'POST',
                        body: data
                    });
                                ...
                                <div class="pt-step-header">
                                    ...
                                    <div class="pt-style-grid">
                                        ...
                                        <label class="pt-style-card">
                                            ...
                                            <img src="<?= base_url() ?>/assets/img/7.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Large/Full Sleeve Realism"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/6.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Micro Realism"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/9.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Fine Line Script"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/8.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Ornamental"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/5.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Color Realism"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/4.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Illustrative"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/3.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Minimal/Fine Line"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/2.jpeg">
                                        ...
                                        <label class="pt-style-card">
                                            <input type="checkbox" name="styles[]" value="Floral"
                                                x-model="selectedStyles">
                                            <img src="<?= base_url() ?>/assets/img/1.jpeg">
                                    ...
                                    <div x-show="selectedGender" class="pt-body-map-section">
                                        ...
                                        <div class="pt-body-view-selector">
                                            <div @click="bodyView = 'front'; isImageView = true"
                                                ...
                                                <img :src="selectedGender === 'Male' ? '<?= url('/assets/img/m-modela.png') ?>' : '<?= url('/assets/img/f-modela.png') ?>'">
                                                <span class="pt-body-view-label">(Front)</span>
                                            </div>
                                            <div @click="bodyView = 'back'; isImageView = true"
                                                class="pt-body-view-option"
                                                :class="{ 'pt-active-view': bodyView === 'back' }">
                                                <img :src="selectedGender === 'Male' ? '<?= url('/assets/img/m-modelb.png') ?>' : '<?= url('/assets/img/f-modelb.png') ?>'">
                                            ...
                                            <div class="pt-svg-wrapper">
                                                <template x-if="selectedGender === 'Male' && bodyView === 'front'">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <image overflow="visible"
                                                            href="<?= base_url() ?>/assets/img/m-modela.png" />
                                                ...
                                                <template x-if="selectedGender === 'Male' && bodyView === 'back'">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <image overflow="visible" width="800" height="1360"
                                                            href="<?= base_url() ?>/assets/img/m-modelb.png" />
                                                        ...
                                                        <path @click="togglePosition('hand-back-rt')" id="mfb_43"
                                                        ...
                                                        <path @click="togglePosition('hand-back-lt')" id="mfb_44"
                                                        ...
                                                        <path @click="togglePosition('hamstring-rt')" id="mfb_45"
                                                        ...
                                                        <path @click="togglePosition('hamstring-lt')" id="mfb_46"
                                                        ...
                                                        <path @click="togglePosition('knee-back-rt')" id="mfb_47"
                                                        ...
                                                        <path @click="togglePosition('knee-back-lt')" id="mfb_48"
                                                        ...
                                                        <path @click="togglePosition('calf-rt')" id="mfb_49"
                                                        ...
                                                        <path @click="togglePosition('calf-lt')" id="mfb_50"
                                                        ...
                                                        <path @click="togglePosition('ankle-back-rt')" id="mfb_51"
                                                        ...
                                                        <path @click="togglePosition('ankle-back-lt')" id="mfb_52"
                                                        ...
                                                        <path @click="togglePosition('sole-rt')" id="mfb_53"
                                                        ...
                                                        <path @click="togglePosition('sole-lt')" id="mfb_54"
                                                        ...
                                                        <path @click="togglePosition('foot-back-rt')" id="mfb_55"
                                                        ...
                                                        <path @click="togglePosition('foot-back-lt')" id="mfb_56"
                                                ...
                                                <template x-if="selectedGender === 'Female' && bodyView === 'front'">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <image overflow="visible" x="0" y="0" width="680" height="1320" preserveAspectRatio="none" href="<?= base_url() ?>/assets/img/f-modela.png" />
                                                        ...
                                                        <path @click="togglePosition('elbow-rt')" id="ffb_11"
                                                            :class="{ 'pt-active-path': selectedPositions.includes('elbow-rt') }"
                                                            class="elbow-rt pt-body-path" fill="transparent"
                                                            stroke="#8C8C8C" vector-effect="non-scaling-stroke"
                                                ...
                                                <template x-if="selectedGender === 'Female' && bodyView === 'back'">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 680 1320" class="pt-body-map-svg">
                                                        <image overflow="visible" x="0" y="0" width="680" height="1320" preserveAspectRatio="none" href="<?= base_url() ?>/assets/img/f-modelb.png" />
                                        ...
                                        <div class="pt-input-wrap">
                                            ...
                                            >
                                                <option value="">— Select an artist —</option>
                                                                                                    ...
                                                                                                    <option value="dani-luz" >Dani Luz</option>
...
<style>
    ...
    .pt-body-overlay[style*="display: none"], [x-cloak].pt-body-overlay {
        display: none !important;
    }
    .pt-body-overlay {
        position: fixed !important;
